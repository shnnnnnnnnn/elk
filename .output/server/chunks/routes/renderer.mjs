...
import { n as eventHandler, o as setResponseHeader, p as send, q as getResponseStatus, t as setResponseStatus, v as useNitroApp, x as setResponseHeaders, y as joinURL, u as useRuntimeConfig, a as getQuery, c as createError, z as getRouteRules, A as getResponseStatusText } from '../runtime.mjs';
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.c4; }).then((r) => r.default || r);
